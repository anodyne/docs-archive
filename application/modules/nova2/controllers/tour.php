...
class Tour extends Controller
{
	...
	function __construct()
	{
		...
		$this->viewpath		= 'modules/'. $this->module .'/pages/tour/';
	...
	public function genres()
	{
		...
		$data['image'] = array(
			'src' => $this->imagepath .'tour/genres.png',
			'alt' => 'genres'
		);
	...
	public function seamless()
	{
		...
		$data['image'] = array(
			'src' => $this->imagepath .'tour/seamless.png',
			'alt' => 'seamless substitution'
		);
...
/* Location: ./application/modules/nova2/controllers/tour.php */