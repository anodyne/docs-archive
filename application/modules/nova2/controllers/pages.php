...
{	
	...
	function __construct()
	{
		...
		$this->viewpath		= 'modules/'. $this->module .'/pages/pages/';
	...
	public function index()
	{
		...
		$js = 'modules/'. $this->module .'/js/pages_main_js';
	...
	public function characters()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 'awards':
				...
				$data['related'] = array(
					$this->module .'/pages/user/nominate' => 'Award Nominations',
					$this->module .'/pages/manage/awards' => 'Manage Crew Awards',
				);
	...
	public function manage()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 'awards':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/awards' => 'Awards Listing',
					$this->module .'/pages/personnel/viewawards' => 'View Personnel Awards',
				);
			...
			case 'decks':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/decks' => 'View Deck Listing',
				);
			...
			case 'depts':
				...
				$data['related'] = array(
					$this->module .'/pages/manage/positions' => 'Position Management',
					$this->module .'/pages/sim/depts' => 'Departments &amp; Positions',
				);
			...
			case 'docked':
				...
				$data['related'] = array(
					$this->module .'/pages/site/dockingform' => 'Docking Form',
					$this->module .'/pages/site/dockingsections' => 'Docking Sections',
					$this->module .'/pages/sim/dockingrequest' => 'Docking Request',
					$this->module .'/pages/sim/docked' => 'Docked Items',
				);
			...
			case 'logs':
				...
				$data['related'] = array(
					$this->module .'/pages/write/personallog' => 'Write Personal Log',
					$this->module .'/pages/sim/listlogs' => 'Personal Logs Listing',
					$this->module .'/pages/sim/viewlog' => 'View Personal Log',
				);
			...
			case 'news':
				...
				$data['related'] = array(
					$this->module .'/pages/write/newsitem' => 'Write News Item',
					$this->module .'/pages/main/news' => 'All News',
					$this->module .'/pages/main/viewnews' => 'View News Item',
					$this->module .'/pages/manage/newscats' => 'Manage News Categories'
				);
			...
			case 'positions':
				...
				$data['related'] = array(
					$this->module .'/pages/manage/depts' => 'Department Management',
					$this->module .'/pages/sim/depts' => 'Departments &amp; Positions',
				);
			...
			case 'posts':
				...
				$data['related'] = array(
					$this->module .'/pages/write/missionpost' => 'Write Mission Post',
					$this->module .'/pages/sim/listposts' => 'Mission Posts Listing',
					$this->module .'/pages/sim/viewpost' => 'View Mission Post',
					$this->module .'/pages/sim/missions' => 'View Missions',
					$this->module .'/pages/manage/missions' => 'Mission Management'
				);
			...
			case 'specs':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/specs' => 'Specifications Listing',
					$this->module .'/pages/site/specsform' => 'Specifications Form Fields',
					$this->module .'/pages/site/specssections' => 'Specifications Form Sections',
				);
			...
			case 'tour':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/tour' => 'Tour Items',
					$this->module .'/pages/sim/decks' => 'Deck Listing',
					$this->module .'/pages/site/tourform' => 'Tour Form Fields',
					$this->module .'/pages/manage/decks' => 'Manage Deck Listing'
				);
	...
	public function report()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 'activity':
				...
				$data['related'] = array(
					$this->module .'/pages/login/index' => 'Logging In',
					$this->module .'/pages/write/missionpost' => 'Write Mission Post',
					$this->module .'/pages/write/personallog' => 'Write Personal Log'
				);
			...
			case 'applications':
				...
				$data['related'] = array(
					$this->module .'/pages/main/join' => 'Join Page',
				);
			...
			case 'loa':
				...
				$data['related'] = array(
					$this->module .'/pages/user/status' => 'Request LOA'
				);
			...
			case 'moderation':
				...
				$data['related'] = array(
					$this->module .'/pages/user/account' => 'User Account',
					$this->module .'/pages/manage/comments' => 'Manage Comments',
					$this->module .'/pages/manage/posts' => 'Manage Mission Posts',
					$this->module .'/pages/manage/logs' => 'Manage Personal Logs',
					$this->module .'/pages/manage/news' => 'Manage News Items',
				);
	...
	public function sim()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 'index':
				...
				$data['related'] = array(
					$this->module .'/pages/site/messages' => 'Site Messages Management'
				);
			...
			case 'awards':
				...
				$data['related'] = array(
					$this->module .'/pages/personnel/viewawards' => 'View Personnel Awards',
					$this->module .'/pages/manage/awards' => 'Award Management'
				);
			...
			case 'decks':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/tour' => 'Sim Tour',
					$this->module .'/pages/manage/decks' => 'Deck Listing Management'
				);
			...
			case 'docked':
				...
				$data['related'] = array(
					...
					$this->module .'/pages/site/dockingsections' => 'Docking Sections',
					$this->module .'/pages/sim/dockingrequest' => 'Docking Request',
					$this->module .'/pages/manage/docked' => 'Docked Item Management',
				);
			...
			case 'listlogs':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/viewlog' => 'View Personal Log',
					$this->module .'/pages/personnel/viewlogs' => 'View Personnel Personal Logs',
					$this->module .'/pages/manage/logs' => 'Personal Log Management',
					$this->module .'/pages/write/personallog' => 'Write Personal Log',
				);
			...
			case 'listposts':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/viewpost' => 'View Mission Post',
					$this->module .'/pages/personnel/viewposts' => 'View Personnel Mission Posts',
					$this->module .'/pages/manage/posts' => 'Mission Post Management',
					$this->module .'/pages/write/missionpost' => 'Write Mission Post',
				);
			...
			case 'missions':
				...
				$data['related'] = array(
					$this->module .'/pages/manage/missions' => 'Mission Management',
					$this->module .'/pages/manage/missiongroups' => 'Mission Group Management'
				);
			...
			case 'specs':
				...
				$data['related'] = array(
					$this->module .'/pages/manage/specs' => 'Specifications Management',
					$this->module .'/pages/site/specsform' => 'Specifications Form Management',
					$this->module .'/pages/site/specssections' => 'Specifications Form Sections Management',
				);
			...
			case 'tour':
				...
				$data['related'] = array(
					$this->module .'/pages/manage/tour' => 'Tour Management',
					$this->module .'/pages/site/tourform' => 'Tour Form Management',
				);
	...
	public function site()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 'bioform':
				...
				$data['related'] = array(
					$this->module .'/pages/site/biosections' => 'Bio Form Sections',
					$this->module .'/pages/site/biotabs' => 'Bio Form Tabs'
				);
			...
			case 'biosections':
				...
				$data['related'] = array(
					$this->module .'/pages/site/bioform' => 'Bio Form Management',
					$this->module .'/pages/site/biotabs' => 'Bio Form Tabs'
				);
			...
			case 'menucats':
				...
				$data['related'] = array(
					$this->module .'/pages/site/menus' => 'Menu Management'
				);
			...
			case 'menus':
				...
				$data['related'] = array(
					$this->module .'/pages/site/menucats' => 'Menu Categories'
				);
			...
			case 'rankcatalogue':
				...
				$data['related'] = array(
					$this->module .'/pages/manage/ranks' => 'Rank Management',
					$this->module .'/pages/user/options' => 'User Site Options'
				);
			...
			case 'rolegroups':
				...
				$data['related'] = array(
					$this->module .'/pages/site/roles' => 'Access Roles',
					$this->module .'/pages/site/rolepages' => 'Access Role Pages'
				);
			...
			case 'rolepages':
				...
				$data['related'] = array(
					$this->module .'/pages/site/roles' => 'Access Roles',
					$this->module .'/pages/site/rolegroups' => 'Access Role Page Groups'
				);
			...
			case 'specsform':
				...
				$data['related'] = array(
					$this->module .'/pages/site/specssections' => 'Specs Sections',
					$this->module .'/pages/sim/specs' => 'Specs',
					$this->module .'/pages/manage/specs' => 'Specs Management'
				);
			...
			case 'specssections':
				...
				$data['related'] = array(
					$this->module .'/pages/site/specsform' => 'Specs Form',
					$this->module .'/pages/sim/specs' => 'Specs',
					$this->module .'/pages/manage/specs' => 'Specs Management'
				);
			...
			case 'tourform':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/tour' => 'Tour',
					$this->module .'/pages/manage/tour' => 'Tour Management'
				);
	...
	public function upload()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 'index':
				...
				$data['related'] = array(
					$this->module .'/pages/upload/manage' => 'Manage Uploads',
				);
			...
			case 'manage':
				...
				$data['related'] = array(
					$this->module .'/pages/upload/index' => 'Upload Images',
				);
	...
	public function user()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 'nominate':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/awards' => 'Crew Awards',
					$this->module .'/pages/manage/awards' => 'Manage Crew Awards',
				);
			...
			case 'options':
				...
				$data['related'] = array(
					$this->module .'/pages/site/rankcatalogue' => 'Rank Catalogue',
					$this->module .'/pages/site/skincatalogue' => 'Skin Catalogue',
				);
	...
	public function write()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 'missionpost':
				...
				$data['related'] = array(
					$this->module .'/pages/sim/viewpost' => 'View Post',
					$this->module .'/pages/sim/listposts' => 'Mission Posts Listing',
					$this->module .'/pages/manage/posts' => 'Mission Post Management'
				);
			...
			case 'newsitem':
				...
				$data['related'] = array(
					$this->module .'/pages/main/news' => 'News',
					$this->module .'/pages/main/viewnews' => 'View News Item',
					$this->module .'/pages/manage/news' => 'News Item Management',
					$this->module .'/pages/manage/newscats' => 'News Category Management'
				);
...
/* Location: ./application/modules/nova2/controllers/pages.php */