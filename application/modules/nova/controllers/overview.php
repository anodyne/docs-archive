...
class Overview extends Controller {
	...
	public function update()
	{
		...
		switch ($this->uri->segment(4))
		{
			...
			case 121:
				$data['header'] = 'Updating From 1.2 to 1.2.1';
				$data['sub'] = $page;
			...
			case 123:
				$data['header'] = 'Updating From 1.2.2 to 1.2.3';
				$data['sub'] = $page;

				$view = $this->viewpath .'update/123';
			break;
			
			case 124:
				$data['header'] = 'Updating From 1.2.3 to 1.2.4';
				$data['sub'] = $page;

				$view = $this->viewpath .'update/124';
			break;
			
			case 125:
				$data['header'] = 'Updating From 1.2.4 to 1.2.5';
				$data['sub'] = $page;

				$view = $this->viewpath .'update/125';
			break;
			
			case 126:
				$data['header'] = 'Updating From 1.2.5 to 1.2.6';
				$data['sub'] = $page;

				$view = $this->viewpath .'update/126';
			break;
