...
<p>Nova&rsquo;s Auth library handles all authentication to the system and authorization once logged in.</p>
...
<p>If you run in to a situation where a user needs to login but they are locked out of their account, you can open the database and navigate to the <var>login_attempts</var> table and delete all records with that user&rsquo;s email address.</p>
...
<table cellpadding="0" cellspacing="1" border="0" class="tableborder zebra">
	...
	<tr>
		...
		<td class="td col4">Determines if the user should be redirected if they don&rsquo;t have access</td>
	</tr>
	<tr>
...
<p>Permits you to check whether the user is currently logged in. If they are&rsquo;t, Nova will attempt to do an autologin if they&rsquo;ve selected to be remembered at the login screen.</p>
...
<table cellpadding="0" cellspacing="1" border="0" class="tableborder zebra">
	...
	<tr>
		...
		<td class="td col4">Whether to set a cookie on the user&rsquo;s computer for autologin</td>
	</tr>
</table>
...
<p>Verify a user&rsquo;s login credentials without triggering the login process.</p>
...
<table cellpadding="0" cellspacing="1" border="0" class="tableborder zebra">
	...
	<tr>
		...
		<td class="td col4">Email address does&rsquo;t exist</td>
	</tr>
	<tr>
