...
<ul>
	<li><?php echo anchor($this->module .'/tutorials/extending', 'Extending Nova');?></li>
	<li><?php echo anchor($this->module .'/tutorials/skins', 'Skinning Nova');?></li>
	<li><?php echo anchor($this->module .'/tutorials/models', 'Models in Nova');?></li>
	<li><?php echo anchor($this->module .'/tutorials/advanced', 'Advanced Tutorials');?></li>
</ul>-->
...
<ul>
	...
	<li><?php echo anchor($this->module .'/developers/differences', 'Differences Between Nova 1 and Nova 2');?> &ndash; a listing of the coding differences between Nova 1 and Nova 2.</li>
</ul>
...
<p><?php echo anchor($this->module .'/libraries/index', 'See all libraries &raquo;');?></p>
...
<p><?php echo anchor($this->module .'/helpers/index', 'See all helpers &raquo;');?></p>
...
<p><?php echo anchor($this->module .'/models/index', 'See all models &raquo;');?></p>-->