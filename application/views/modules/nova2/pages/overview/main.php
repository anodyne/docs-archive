<div class="main-container">
	...
	<div class="main-right">
		<!--<div class="main-panel">
			...
			<ul>
				...
				<li><?php echo anchor($this->module .'/overview/upgrade', 'SMS Upgrade Guide');?></li>
				<li><?php echo anchor($this->module .'/overview/update', 'Updating Nova');?></li>
				<li><?php echo anchor($this->module .'/tutorials/intro/backup', 'Backup Guide');?></li>
			</ul>
		</div>
		...
		<div class="main-panel">
			...
			<p><?php echo anchor($this->module .'/pages/index', 'See all pages guides &raquo;');?></p>
		</div>-->
		...
		<div class="main-panel">
			...
			<p><?php echo anchor($this->module .'/developers/index', 'See developer resources &raquo;');?></p>
		</div>
	</div>
	...
	<div class="main-left">
		<div class="main-panel">
			...
			<p>These links provide general information about Nova 2 includes changes, licenses and requirements.</p>
			<ul>
				<li><?php echo anchor($this->module .'/overview/changes', 'Changes Since Nova 1');?></li>
				<!--<li><?php echo anchor($this->module .'/overview/changelog', 'Change Log');?></li>-->
				<li><?php echo anchor($this->module .'/overview/license/nova', 'Nova License Agreement');?></li>
				<li><?php echo anchor($this->module .'/overview/license/kohana', 'Kohana License Agreement');?></li>
		...
		<!--<div class="main-panel">
			...
			<p><?php echo anchor($this->module .'/tour/index', 'Take a tour of Nova &raquo;');?></p>
		</div>
		...
		<div class="main-panel">
			...
			<ul>
				<li><?php echo anchor($this->module .'/tutorials/index#intro', 'Getting Started with Nova');?></li>
				<li><?php echo anchor($this->module .'/tutorials/index#skinning', 'Skinning');?></li>
				<li><?php echo anchor($this->module .'/tutorials/index#advanced', 'Advanced Tutorials');?></li>
			</ul>
		</div>-->
	</div>
</div>