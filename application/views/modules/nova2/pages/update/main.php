...
<ul>
	<li><?php echo anchor($this->module .'/overview/update/nova1', 'Updating from Nova 1');?></li>
	<li><?php echo anchor($this->module .'/overview/update/201', 'Updating from 2.0 to 2.0.1');?></li>
</ul>