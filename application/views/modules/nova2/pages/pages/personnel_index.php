...
<p>The second line of the small navigation at the top is a toggle control. Click on the item once will toggle that item to be shown (if it&rsquo;s hidden). Clicking it again will hide it (or vice versa if the reverse is true). There are two toggle links: non-playing characters and open positions.</p>

<p>Manifest defaults are controlled through the Site Settings page.</p>

<p>The manifest is grouped by departments in the order they are set in the Department Management page. Within each department are that department&rsquo;s positions in the order they are set in the Position Management page. For each position, if there is a character in that position, they&rsquo;re displayed on the line. If there isn&rsquo;t a character in that role, it will display a link to apply for the position. In order for a position to appear with a link to apply, that position needs to have at least 1 open slot. The number of open slots can be changed from the Position Management page.</p>

<p>One new feature in Nova is sub departments, or departments within departments. If there is a sub department as part of a department, it will display the heading for the sub department along with all its positions at the bottom of the list of a department&rsquo;s positions. Sub departments and their positions work the same way as normal departments and their positions, and all of them can be edited from the Department Management and Position Management pages.</p>
