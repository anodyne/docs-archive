...
<p>To delete an access role, click on the <a href="#" class='tip' tooltip='<?php echo img($images['delete']);?>'>delete icon</a> to the right of the list of roles. A modal window will pop up confirming that you want to delete that role. If you want to delete the role, you have to first select a new role to assign all users to who currently have the role you want to delete. Once you&rsquo;ve clicked Submit, the role will be removed from the database. If you do not want to delete that access role, you can hit Escape, click anywhere outside of the modal window or click the X icon in the upper lefthand corner of the modal window.</p>
