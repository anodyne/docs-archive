...
<p>While Nova is highly focused on the game itself you&rsquo;re playing, players are also an integral part and have to be able to update their account with new information, be that a new email address or security question or any of the other various settings available to every player. The User Account page allows players to update their own account or admins to update other players&rsquo; accounts (including resetting passwords).</p>
