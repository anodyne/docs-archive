...
<p>To reject a pending character, click on the <a href="#" class='tip' tooltip='<?php echo img($images['reject']);?>'>reject icon</a> to the right of their name.</p>
...
<p>To edit a player's account, click on the <a href="#" class='tip' tooltip='<?php echo img($images['account']);?>'>account icon</a> to the right of their name and you will be redirected to their account page.</p>
