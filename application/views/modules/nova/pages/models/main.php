...
<ul>
	<li><?php echo anchor('nova/models/access', 'Access');?></li>
	<li><?php echo anchor('nova/models/applications', 'Applications');?></li>
	<li><?php echo anchor('nova/models/awards', 'Awards');?></li>
	<li><?php echo anchor('nova/models/characters', 'Characters');?></li>
	<li><?php echo anchor('nova/models/depts', 'Departments');?></li>
	<li><?php echo anchor('nova/models/docking', 'Docking');?></li>
	<li><?php echo anchor('nova/models/menu', 'Menu');?></li>
	<li><?php echo anchor('nova/models/messages', 'Messages');?></li>
	<li><?php echo anchor('nova/models/missions', 'Missions');?></li>
	<li><?php echo anchor('nova/models/news', 'News');?></li>
	<li><?php echo anchor('nova/models/personallogs', 'Personal Logs');?></li>
	<li><?php echo anchor('nova/models/positions', 'Positions');?></li>
	<li><?php echo anchor('nova/models/posts', 'Posts');?></li>
	<li><?php echo anchor('nova/models/privmsgs', 'Private Messages');?></li>
	<li><?php echo anchor('nova/models/ranks', 'Ranks');?></li>
	<li><?php echo anchor('nova/models/rss', 'RSS');?></li>
	<li><?php echo anchor('nova/models/settings', 'Settings');?></li>
	<li><?php echo anchor('nova/models/specs', 'Specs');?></li>
	<li><?php echo anchor('nova/models/system', 'System');?></li>
	<li><?php echo anchor('nova/models/tour', 'Tour');?></li>
	<li><?php echo anchor('nova/models/users', 'Users');?></li>
	<li><?php echo anchor('nova/models/wiki', 'Wiki');?></li>
</ul>
...
<p class="fontSmall"><em>* Model object name would conflict with an existing library</em></p>

<br />
<p class="fontSmall"><em>Text about models from the <a href="http://codeigniter.com/user_guide/general/models.html" target="_blank">CodeIgniter User Guide</a>.</em></p>