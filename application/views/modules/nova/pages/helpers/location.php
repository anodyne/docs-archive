...
<p class="important">The mailtype is pulled from the <samp>application/config/email.php</samp> file. Changing that variable to <var>text</var> would change where the email location helper looks by default.</p>
