...
<ul class="changelog">
	...
	<li class="script">application/models/base/positions_model_base.php</li>
	...
	<li class="script">application/views/_base/admin/ajax/add_dept.php</li>
	...
	<li class="script">application/views/_base/admin/ajax/dup_dept.php</li>
	<li class="script">application/views/_base/admin/js/manage_depts_js.php</li>
