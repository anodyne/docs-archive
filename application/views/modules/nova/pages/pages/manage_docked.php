...
<p>To delete a docked item, click on the <a href="#" class='tip' tooltip='<?php echo img($images['delete']);?>'>delete icon</a> to the right of its name. A modal window will pop-up asking you to confirm you want to delete the item. Once you have clicked <strong>Submit</strong>, Nova will delete the docked item.</p>

<h2>Editing a Docked Item</h2>

<p>To edit a docked item, click on the <a href="#" class='tip' tooltip='<?php echo img($images['edit']);?>'>edit icon</a> to the right of its name and you will be redirected to the edit docked item page for the respective item.</p>

<h2>Viewing a Docked Item</h2>

<p>To view a docked item, click on the <a href="#" class='tip' tooltip='<?php echo img($images['view']);?>'>view icon</a> to the right of its name and you will be redirected to the docked item display page.</p>

<h2>Accepting a Pending Docking Request</h2>

<p>To accept a pending docking request, click on the <a href="#" class='tip' tooltip='<?php echo img($images['accept']);?>'>accept icon</a> to the right of its name. A modal window will pop-up asking you to confirm the acceptance and give you the opportunity to change the email message they will receive. Once you click <strong>Submit</strong> the item will be accepted and an email will be sent to the game master who applied as well as anyone with <kbd>manage/docked</kbd> privileges.</p>
