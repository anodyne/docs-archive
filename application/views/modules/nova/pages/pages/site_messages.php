...
<p>Nova stores many of the messages found throughout the system in the database to allow admins to quickly and easily update their site&rsquo;s messages without having to wade into PHP or HTML code. The Nova database is also set up in such a way to allow for additional messages and headers to be created and used throughout user-created pages or even, using seamless substitution, on core pages.</p>
