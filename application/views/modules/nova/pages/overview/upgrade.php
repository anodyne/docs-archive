...
<p>Before you do anything with Nova, we recommend that you follow the <?php echo anchor('nova/tutorials/intro/backup', 'Backup Guide');?> to back up your SMS files and database before beginning.</p>
...
<h4>Characters Management Page</h4>
