...
<p>CodeIgniter has an extensive list of options for configuring connections to the database. These options are covered in more depth in the <?php echo anchor('nova/overview/install', 'Installation page');?>. Database connection information can be found in the <samp>./application/config/database.php</samp> file.</p>
