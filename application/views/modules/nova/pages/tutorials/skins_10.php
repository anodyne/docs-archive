...
<p class="important"><strong>Note:</strong> If you want to know what an image is named, you can open <samp>application/views/_base/main/images</samp> to see all the icons.</p>
