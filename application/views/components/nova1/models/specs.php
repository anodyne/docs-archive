<h1>Specifications Model</h1>

<p>The Specifications model provides access to the specifications database table for storing, editing deleting and retrieving specification information.</p>

<h2>Loading the Model</h2>

<p>This model is loaded using the following code:</p>

<pre>$this->load->model('specs_model', 'specs');</pre>

<h2>Using the Model</h2>

<p>You can use the methods in the model and listed on the page in the following manner:</p>

<pre>$this->specs->method_name();</pre>
