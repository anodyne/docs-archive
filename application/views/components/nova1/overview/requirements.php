...
<ul>
	<li>PHP version 4.3.2 or newer (PHP 5.0 or newer required for Nova's mini-wiki and SMS Archives feature)</li>
	<li>MySQL version 4.1+ or MySQLi</li>
	<li>Apache or IIS</li>
...
<ul>
	<li>PHP version 5.2 or newer</li>
...
<p>In order to run at peak performance and with all features enabled, Nova requires that Javascript be turned <dfn>ON</dfn>. In addition, Anodyne recommends running a standards compliant browser like Firefox or Google Chrome for using the system. Nova will work in Internet Explorer 7 or higher, Firefox 2 or higher, Safari 3 or higher and Google Chrome.</p>