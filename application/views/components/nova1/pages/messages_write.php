...
<p>Replying to a private message you've received is almost identical to writing a message. You will see the same dropdown menu (this time it will be populated with the person you're replying to). The subject will be populated with the subject of the message you're replying to, prepended by the phrase RE: and there will be a box below the composition fields with the content of the message you're replying to. Like writing a new private message, you can choose to add multiple recipients to the message in the same way you would for a new private message.</p>
...
<p>Replying to everyone involved in a private message you've received is identical to replying to a message. You will see the same dropdown menu, the subject will be populated with the subject of the message you're replying to, prepended by the phrase RE: and there will be a box below the composition fields with the content of the message you're replying to. Unlike replying to a private message, the dropdown menu will not be populated with the author. Instead, there will be a list below the dropdown menu with the people who will receive the message. Every member in the list will have their name disabled in the dropdown list to prevent them from being added multiple times. You can type your message as you normally would and send the private message to everyone involved in your private message.</p>

<p>You cannot reply to all of a message you are not the author of or a recipient of.</p>

<h2>Forwarding a Private Message</h2>

<p>Forwarding a private message you've received is almost identical to write a new message. You will see the same dropdown menu, the subject will be populated with the subject of the message you're forwarding, prepended by the phrase FWD: and the message box will be populated with the private message you're forwarding. Like writing a new message, you can add multiple recipients in the same way you would for writing a new private message.</p>
