...
<p>The news page will display all news that's in the database in the activated state in an abbreviated state (by default, the first 50 words of the item). Pending and saved news items will not show up. If you are logged in, private news items will also appear in the list.</p>
