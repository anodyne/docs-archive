...
<p>Like most other components in Nova, you can easily edit a personal log by clicking on the edit icon and making your changes in the pop-up window that appears. Clicking <strong>Submit</strong> will complete the update and the changes will be seen immediately for that personal log.</p>

<h2>Deleting a Personal Log</h2>

<p>Deleting a personal log is only a matter of clicking on the delete icon and confirming you want to delete the log by clicking <strong>Submit</strong>. If you decide that you don't want to delete the log, you can get out of the modal window by either clicking the X in the upper corner, hitting escape on your keyboard or clicking anywhere outside the window.</p>

<h2>Approving a Personal Log</h2>

<p>If an admin has set a moderation flag on a player's ability to post personal logs, their logs will automatically be held for review. If that happens, Nova will send an email out to anyone with <kbd>manage/logs</kbd> permissions to notify them of a pending log. In addition, a notification will appear in the admin control panel as well. (If you want to view the personal log, you can click the view icon and you'll be taken to that personal log.) You can choose to approve the personal log by clicking on the approve icon and confirming you want to approve that log by clicking <strong>Submit</strong>. If you do not want to approve the log, simply delete it.</p>