...
<p>In any RPG, there are levels of seniority. Often, those levels are displayed through the use of ranks. Most of the genres Nova ships with involve ranks as a fundamental way of showing a character's status in the chain of command (though that doesn't always reflect seniority in the RPG's management group). Nova uses a series of rank images (unique for each genre) to highlight ranks of characters. From the Rank Management page, admins can updated all the ranks available throughout the system.</p>

<p>Rank Management displays two informational boxes at the top of the page. The first is a listing of the different rank sets available, represented by the rank set's preview image. Every rank set in Nova must have a preview image; if it doesn't have a preview image, the ranks will not display through the management system. Below the listing of rank sets is a listing of rank classes. For rank sets that don't use a lot of classes, these won't mean a lot. However, some ranks sets have multiple classes. Clicking on the images will switch the classes to allow admins to change different portions of the set.</p>

<h3>Permissions</h3>

<p>In order to manage ranks, you need to have <kbd>manage/ranks</kbd> permissions.</p>
