	...
	<li class="span4">
		<div class="thumbnail">
			<div class="caption">
				...
				<p><a href="<?php echo Url::site('nova1/overview/index');?>" class="btn">Go to Nova 1 user guide</a></p>
			</div>
		</div>
	</li>
	...
	<li class="span4">
		<div class="thumbnail">
			<div class="caption">
				...
				<p><a href="<?php echo Url::site('nova2/overview/index');?>" class="btn">Go to Nova 2 user guide</a></p>
			</div>
		</div>
	</li>
