...
<p class="important"><strong>Note:</strong> This helper has been extended from the CodeIgniter default. Changes to this library can be found in the <samp>MY_url_helper.php</samp> file in <samp>application/helpers</samp>. Do not edit the CodeIgniter core helper file! Documentation for the core helper is available <a href="http://codeigniter.com/user_guide/helpers/url_helper.html" target="_blank">here</a>.</p>
