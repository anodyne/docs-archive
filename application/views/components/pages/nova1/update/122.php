...
<h1>Updating From 1.2.1 to 1.2.2</h1>
...
<p><em>There are no updates to the CodeIgniter core in Nova 1.2.2.</em></p>
...
<ul class="changelog">
	...
	<li class="script"><input type="checkbox" /> <span>application/controllers/base/manage_base.php</span></li>
	<li class="script"><input type="checkbox" /> <span>application/controllers/base/write_base.php</span></li>
