...
<h1>Updating From 1.2.5 to 1.2.6</h1>
...
<p><em>There are no updates to the CodeIgniter core in Nova 1.2.6.</em></p>
...
<ul class="changelog">
	...
	<li class="script"><input type="checkbox" /> <span>application/views/_base/admin/pages/write_index.php</span></li>
</ul>
