...
<h1>Updating From 1.2.2 to 1.2.3</h1>
...
<p><em>There are no updates to the CodeIgniter core in Nova 1.2.3.</em></p>
...
<ul class="changelog">
	...
	<li class="script"><input type="checkbox" /> <span>application/controllers/base/sim_base.php</span></li>
	<li class="script"><input type="checkbox" /> <span>application/views/_base/main/pages/sim_decks.php</span></li>
</ul>
