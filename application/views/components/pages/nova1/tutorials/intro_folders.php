...
<ul>
	...
	<li><strong>libraries</strong> &ndash; Libraries are PHP classes designed with a specific set of actions in mind. CodeIgniter contains many of these and we've also built some of our own for Nova as well. More information about libraries specific to Nova can be found <?php echo Html::anchor('nova1/libraries', 'here');?>.</li>
