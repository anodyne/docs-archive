...
<p class="important"><strong>Note:</strong> When building a maintenance.php page, you don't have to know any PHP, you can simply build an HTML page then change the extension to .php before you upload it.</p>
