...
<p>To edit a mission in Nova, simply click on the <a href="#" class='tip' tooltip='<?php echo img($images['edit']);?>'>edit icon</a> to the right of the mission information. You will be redirected to a page with two tabs: info and images. In the info tab, update all of the fields you want. When you've finished updating the fields in the info tab, click on the images tab and select your image from a list of uploaded images (if you have any) or use the text field to manually put the name of the image in the field. Once you're done, click <strong>Submit</strong> and Nova will update the mission.</p>

<h2>Deleting a Mission</h2>

<p>To delete a mission from Nova, simply click on the <a href="#" class='tip' tooltip='<?php echo img($images['delete']);?>'>delete icon</a> to the right of the mission information. A modal window will appear and ask you to confirm you want to delete the mission. If you do, click <strong>Submit</strong> and Nova will delete the mission. If you don't want to delete the mission, you can click anywhere outside of the modal window, click the X or hit the Escape key to abort the delete process.</p>
