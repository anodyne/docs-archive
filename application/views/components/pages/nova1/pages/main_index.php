...
<p>The index page of the main section is, by default, the first page someone lands at when they go to your site. You can change which section is loaded when nothing is explicitly stated in the URL in the <samp>application/config/routes.php</samp> file. All you have to do is change the <var>$route[&rsquo;default_controller&rsquo;]</var> from main to whatever controller (section) you want to be loaded first.</p>

<h2>Welcome</h2>

<p>The main title is controlled through the Site Messages page. You can change the title to be whatever you want. Likewise, the content below the title is controlled through the same page and can be changed to whatever you&rsquo;d like. For both, you can include some &ldquo;light HTML&rdquo; (&lt;strong>, &lt;em>, &lt;font>, &lt;span>) if you want. We don&rsquo;t recommend trying to put tables and divs in either.</p>
