...
<p>To create a new access page group, simply click on the Add Role Page Group link. A modal box will pop-up on the screen with all the fields you need to fill-in. After supplying the name of the group and its order, just click Submit and your role page group will be created. Once created, you&rsquo;ll be able to add your new pages to the group.</p>
