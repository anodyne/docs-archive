...
<p class="alert alert-info"><strong>Note:</strong> Because some of these preferences are tied so tightly into the email system, we do not currently allow admins to add their own preferences. In the future, we may allow admin-created user preferences.</p>
