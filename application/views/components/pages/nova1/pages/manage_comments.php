...
<p>Like most other components in Nova, you can easily edit a comment by clicking on the edit icon and making your changes in the pop-up window that appears. Clicking <strong>Submit</strong> will complete the update and the changes will be seen immediately for that comment.</p>

<h2>Deleting a Comment</h2>

<p>Deleting a comment is only a matter of clicking on the delete icon and confirming you want to delete the comment by clicking <strong>Submit</strong>. If you decide that you don't want to delete the comment, you can get out of the modal window by either clicking the X in the upper corner, hitting escape on your keyboard or clicking anywhere outside the window.</p>

<h2>Approving a Comment</h2>

<p>If an admin has set a moderation flag on a player's ability to comment on posts, their comments will automatically be held for review. If that happens, Nova will send an email out to anyone with <kbd>manage/comments</kbd> permissions to notify them of a pending comment. In addition, a notification will appear in the admin control panel as well. While activated comments only show the first 25 words, pending comments will show you the entire comment string. You can choose to approve the comment by clicking on approve icon and confirming you want to approve that comment by clicking <strong>Submit</strong>. If you do not want to approve the comment, simply delete it.</p>