...
<p class="alert alert-info"><strong>Note:</strong> Nova does not support joint mission abilities. All joint missions will need to be run by other means.</p>
...
<p class="alert alert-info">This page is disabled by default in Nova. Setting up your RPG as a base will automatically enable the menu item.</p>