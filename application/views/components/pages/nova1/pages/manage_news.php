...
<p>RPGs aren't all about the story. Sometimes, it's important to get information out to the players. In that case, Nova has a built-in news feature which allows anyone to post news items that will be emailed out to the crew. Using the features on this page, you can manage news items.</p>
...
<p>Deleting a news item is only a matter of clicking on the delete icon and confirming you want to delete the news item by clicking <strong>Submit</strong>. If you decide that you don't want to delete the news item, you can get out of the modal window by either clicking the X in the upper corner, hitting escape on your keyboard or clicking anywhere outside the window.</p>

<h2>Approving a News Item</h2>

<p>If an admin has set a moderation flag on a player's ability to send news items, any news items they post will automatically be held for review. If that happens, Nova will send an email out to anyone with <kbd>manage/news</kbd> permissions to notify them of a pending news item. In addition, a notification will appear in the admin control panel as well. (If you want to view the news item, you can click the view icon and you'll be taken to that news item.) You can choose to approve the news item by clicking on the approve icon and confirming you want to approve that news item by clicking <strong>Submit</strong>. If you do not want to approve the news item, simply delete it.</p>