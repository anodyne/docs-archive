...
<ul>
	<li><a href="<?php echo Url::site('nova1/overview/install');?>">Install Guide</a></li>
	<li><a href="<?php echo Url::site('nova1/overview/upgrade');?>">SMS Upgrade Guide</a></li>
	<li><a href="<?php echo Url::site('nova1/overview/update');?>">Updating Nova</a></li>
	<li><a href="<?php echo Url::site('nova1/tutorials/intro/backup');?>">Backup Guide</a></li>
	<li><a href="<?php echo Url::site('nova1/overview/whatsnew');?>">What's New?</a></li>
</ul>
