<div class="main-container">
	...
	<div class="main-right">
		...
		<div class="main-panel">
			...
			<p><?php echo Html::anchor('nova1/pages/index', 'See all pages guides &raquo;');?></p>
		</div>
		...
		<div class="main-panel">
			...
			<p><?php echo Html::anchor('nova1/developers/index', 'See developer resources &raquo;');?></p>
		</div>
	</div>
	...
	<div class="main-left">
		...
		<div class="main-panel">
			...
			<p><?php echo Html::anchor('nova1/tour/index', 'Take a tour of Nova &raquo;');?></p>
		</div>
		...
		<div class="main-panel">
			...
			<ul>
				<li><?php echo Html::anchor('nova1/tutorials/index#intro', 'Getting Started with Nova');?></li>
				<li><?php echo Html::anchor('nova1/tutorials/index#skinning', 'Skinning');?></li>
				<li><?php echo Html::anchor('nova1/tutorials/index#advanced', 'Advanced Tutorials');?></li>
			</ul>
		</div>
	</div>
</div>