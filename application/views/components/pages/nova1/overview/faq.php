...
<div class="faq">
	...
	<p class="answer hidden">If you have level 2 user/account privileges (you'll know because you'll see an admin tab when you go to anyone's account) then you can change that player's role from the admin tab of the user account page. You can find more information about user accounts at the <a href="<?php echo Url::site('nova1/pages/user/account');?>">User Account</a> page guide.</p>
</div>
...
<div class="faq">
	...
	<p class="answer hidden">Nova only allows you to write mission posts with playing characters and non-playing character who are linked to a playing character. Once an NPC has been linked to a playing character, their name will appear in the Other Authors dropdown menu when composing a new mission post. More information about linking character can be found on <a href="<?php echo Url::site('nova1/pages/user/link');?>">this page</a>.</p>
</div>

<div class="faq">
	<p class="question bold">Why can't I add any of my own NPCs to the authors list when writing a mission post?</p>
	<p class="answer hidden">This is a limitation of Nova's posting system. You can only add one of your own characters to a post and whatever other playing characters or NPCs that are linked to a player throughout the system. It's a limitation we're well aware of, but fixing it would require re-writing a vast majority of the code surrounding the component (and there's a lot of it). For the time being, you can save the post then edit the post and add the NPCs you want from there.</p>
</div>