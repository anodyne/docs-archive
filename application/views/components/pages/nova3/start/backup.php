...
<p>There's always a lot of talking about making sure to back up SMS and/or Nova before attempting to update it or upgrade from SMS to Nova, but how do you backup the systems? Creating a backup of either system is pretty straightforward.</p>
...
<p>The first step to creating a solid backup is to save the SMS files off your server to your computer. To do that, you'll need to have an FTP program to connect to the server. Once you've connected to your account with the username, password and location your host gave to you when your account was created, you can download the files. The best way of going about this is to create a folder on your Desktop called <samp>sms_backup</samp> and to copy all the files directly over to that folder. Make sure you get all the files! Once you have all the files, you can disconnect from the server and close your FTP program.</p>
...
<p>In the export box, click Select All and make sure the SQL option is selected below. In the Options box to the right, make sure both Structure and Data checkboxes are checked. Finally, click the Save as File checkbox then Go. The system will offer you a download of the SQL database. Save the file to your <samp>sms_backup</samp> folder on your Desktop.</p>

<h3>Zip It Up</h3>

<p>Now that you have your complete backup, you should zip your backup up into a zip archive and name it <samp>sms_backup_{date}</samp> where <strong>{date}</strong> is today's date. Make sure you save the zip file in a safe place in case you need to get at it. That's it. You've successfully backed up SMS!</p>
