...
<ul>
	<li><a href="<?php echo Url::site('nova2/start/update/126_to_200');?>">Nova 1.2.6 to Nova 2.0</a></li>
	<li><a href="<?php echo Url::site('nova2/start/update/125_to_126');?>">Nova 1.2.5 to Nova 1.2.6</a></li>
