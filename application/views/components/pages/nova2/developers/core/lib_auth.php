...
<pre>Auth::check_access('messages/index');</pre>
...
<pre>Auth::check_access('', FALSE, TRUE);

Auth::check_access('site/settings', FALSE, TRUE);</pre>

<h2>Auth::get_access_level()</h2>
