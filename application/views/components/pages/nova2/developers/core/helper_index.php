...
<ul>
	<li><?php echo Html::anchor('nova2/core/helpers/debug', 'Debug Helper');?></li>
	<li><?php echo Html::anchor('nova2/core/helpers/panel', 'Panel Helper');?></li>
	<li><?php echo Html::anchor('nova2/core/helpers/utility', 'Utility Helper');?></li>
</ul>

<h3>Extended Helpers</h3>

<ul>
	<li><?php echo Html::anchor('nova2/core/helpers/date', 'Date Helper');?></li>
	<li><?php echo Html::anchor('nova2/core/helpers/form', 'Form Helper');?></li>
	<li><?php echo Html::anchor('nova2/core/helpers/html', 'HTML Helper');?></li>
	<li><?php echo Html::anchor('nova2/core/helpers/language', 'Language Helper');?></li>
	<li><?php echo Html::anchor('nova2/core/helpers/url', 'URL Helper');?></li>
</ul>