...
<p>The Panel Helper file contains functions that assist in actions related to the <?php echo Html::anchor('nova2/core/libraries/userpanel', 'User Panel Library')?>.</p>
