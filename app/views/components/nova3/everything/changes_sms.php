...
<ul>
	...
	<li>Updated to jQuery 1.6 (up from version 1.2.6)</li>
...
<ul>
	...
	<li>Added mission groups that can be nested 1 level deep for grouping missions together into arcs, seasons, by topic or any other criteria</li>
	...
	<li>Deck listing includes a handy menu for moving through decks quickly</li>
</ul>
