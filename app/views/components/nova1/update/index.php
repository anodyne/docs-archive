...
<p>A complete change can be found <a href="<?php echo Uri::create('nova1/overview/changelog');?>">here</a>.</p>
...
<ul>
	<li><a href="<?php echo Uri::create('nova1/overview/update/126');?>">Updating from 1.2.5 to 1.2.6</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/125');?>">Updating from 1.2.4 to 1.2.5</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/124');?>">Updating from 1.2.3 to 1.2.4</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/123');?>">Updating from 1.2.2 to 1.2.3</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/122');?>">Updating from 1.2.1 to 1.2.2</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/121');?>">Updating from 1.2 to 1.2.1</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/120');?>">Updating from 1.1.2 to 1.2</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/112');?>">Updating from 1.1.1 to 1.1.2</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/111');?>">Updating from 1.1 to 1.1.1</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/110');?>">Updating from 1.0.6 to 1.1</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/106');?>">Updating from 1.0.5 to 1.0.6</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/105');?>">Updating from 1.0.4 to 1.0.5</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/104');?>">Updating from 1.0.3 to 1.0.4</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/103');?>">Updating from 1.0.2 to 1.0.3</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/102');?>">Updating from 1.0.1 to 1.0.2</a></li>
	<li><a href="<?php echo Uri::create('nova1/overview/update/101');?>">Updating from 1.0 to 1.0.1</a></li>
</ul>
