...
<pre>$this->load->model('news_model', 'news');</pre>
...
<p class="alert alert-danger"><strong>Warning:</strong> To avoid orphan news comment records, Nova will also delete all news comments associated with the news item.</p>
