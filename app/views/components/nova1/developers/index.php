...
<ul>
	<li><a href="<?php echo Uri::create('nova1/tutorials/extending');?>">Extending Nova</a></li>
	<li><a href="<?php echo Uri::create('nova1/tutorials/skins');?>">Skinning Nova</a></li>
	<li><a href="<?php echo Uri::create('nova1/tutorials/models');?>">Models in Nova</a></li>
	<li><a href="<?php echo Uri::create('nova1/tutorials');?>">Advanced Tutorials</a></li>
</ul>

<h2>Resources</h2>

<ul>
	<li><a href="<?php echo Uri::create('nova1/developers/images');?>">Image Index</a> &ndash; a complete listing of all icons used by the system, their names and where they're found in the system. This is a great resource if you're using seamless substitution and you want to know where icons you're changing will be seen.</li>
	<li><a href="<?php echo Uri::create('nova1/developers/fields');?>">Database Fields Index</a> &ndash; a complete listing of all the database fields in the system.</li>
</ul>
...
<p><a href="<?php echo Uri::create('nova1/libraries/index');?>">See all libraries &raquo;</a></p>
...
<p><a href="<?php echo Uri::create('nova1/helpers/index');?>">See all helpers &raquo;</a></p>
...
<p><a href="<?php echo Uri::create('nova1/models/index');?>">See all models &raquo;</a></p>