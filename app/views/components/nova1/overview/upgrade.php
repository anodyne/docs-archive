...
<p>Before you do anything with Nova, we recommend that you follow the <a href="<?php echo Uri::create('nova1/tutorials/intro/backup');?>">Backup Guide</a> to back up your SMS files and database before beginning.</p>
