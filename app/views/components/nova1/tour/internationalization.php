...
<div class="btn-group pull-right">
	<?php echo Html::anchor('nova1/tour/wiki', '&laquo; Thresher Mini-Wiki', array('class' => 'btn large'));?>
	<?php echo Html::anchor('nova1/tour/littlethings', 'All the Little Things... &raquo;', array('class' => 'btn large'));?>
</div>