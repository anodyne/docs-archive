			...
			<div class="row">
				<div class="span4">
					...
					<ul>
						...
						<li><a href="<?php echo Url::site('nova2/modify/addimage');?>">Add an image to a page</a></li>
						<li><a href="<?php echo Url::site('nova2/modify/language');?>">Change language items in Nova</a></li>
					</ul>
				</div>
				...
				<div class="span4">
					...
					<ul>
						...
						<li><a href="<?php echo Url::site('nova2/modify/changeappfolder');?>">Change the application directory</a></li>
						<li><a href="<?php echo Url::site('nova2/modify/changeindex');?>">Change the index file</a></li>
		...
		<div id="core" class="tab-pane">
			<ul class="thumbnails">
				<li class="span4">
					<div class="thumbnail">
						<div class="caption">
							<img src="<?php echo Url::base();?>application/views/design/images/nova2/nova-core.png" alt="Helpers">
							<h2>Helpers</h2>
							...
							<p><a href="<?php echo Url::site('nova2/core/helpers');?>" class="btn">Helpers Reference</a></p>
						</div>
					</div>
				</li>
				...
				<li class="span4">
					<div class="thumbnail">
						<img src="<?php echo Url::base();?>application/views/design/images/nova2/libraries.png" alt="Libraries">
						<div class="caption">
							<h2>Libraries</h2>
							...
							<p><a href="<?php echo Url::site('nova2/core/libraries');?>" class="btn">Libraries Reference</a></p>
						</div>
					</div>
				</li>
				...
				<li class="span4">
					<div class="thumbnail">
						<div class="caption">
							<img src="<?php echo Url::base();?>application/views/design/images/nova2/models.png" alt="Models">
							<h2>Models</h2>
							...
							<p><a href="<?php echo Url::site('nova2/core/models');?>" class="btn">Models Reference</a></p>
						</div>
					</div>
				</li>
			</ul>
