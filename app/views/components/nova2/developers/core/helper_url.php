...
<p class="alert alert-info"><strong>Note:</strong> This helper has been extended from the CodeIgniter default. Changes to this library can be found in the <code>MY_url_helper.php</code> file in <code>nova/modules/core/helpers</code>. Do not edit the CodeIgniter core helper file! Documentation for the core helper is available <a href="http://codeigniter.com/user_guide/helpers/url_helper.html" target="_blank">here</a>.</p>
