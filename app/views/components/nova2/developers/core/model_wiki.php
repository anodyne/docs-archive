...
<p>The Wiki model provides access to the wiki database tables for storing, editing and retrieving wiki information.</p>

<h2>Loading the Model</h2>

<p>This model is loaded using the following code:</p>

<pre>$this->load->model('wiki_model', 'wiki');</pre>
