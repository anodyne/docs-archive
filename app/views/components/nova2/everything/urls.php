...
<pre class="">http://localhost/nova/index.php/main/credits/1</pre>

<p>Let's look closer at each part of the URL:</p>

<ul>
	<li><strong>http://localhost/nova/index.php</strong> &ndash; On my development server, I've created a folder called nova for all of the Nova files. As you can see, the index.php file that handles all requests is sitting within that folder's root.</li>
	
	<li><strong>/main</strong> &ndash; The next part of the URL is the controller that is being requested within Nova. In this example, we are requesting a controller called <kbd>Main</kbd>. Controllers in Nova can be found in <code>app/controllers</code>. This is the first segment of the URI and can be accessed using the URI library with <dfn>$this->uri->segment(1)</dfn>.</li>
