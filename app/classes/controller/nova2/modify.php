...
class Controller_Nova2_Modify extends Controller_Template {
	...
	{
		$this->template->content = View::factory('components/nova2/developers/modify/index');
	...
	{
		$this->template->content = View::factory('components/nova2/developers/modify/basic_ss_addimage');
	...
	{
		$this->template->content = View::factory('components/nova2/developers/modify/basic_ss_icons');
	...
	{
		$this->template->content = View::factory('components/nova2/developers/modify/basic_language');
	...
	{
		$this->template->content = View::factory('components/nova2/developers/modify/int_change_appfolder');
	...
	{
		$this->template->content = View::factory('components/nova2/developers/modify/int_change_index');
	...
	{
		$this->template->content = View::factory('components/nova2/developers/modify/int_new_page');
	...
	{
		$this->template->content = View::factory('components/nova2/developers/modify/adv_github');
